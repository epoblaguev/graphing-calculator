 ...
 */
public class AddMaxPointDialog extends JFrame implements ActionListener, KeyListener {
    ...
    public AddMaxPointDialog(GraphingTab graphTab, double x, double range) {
        super();
